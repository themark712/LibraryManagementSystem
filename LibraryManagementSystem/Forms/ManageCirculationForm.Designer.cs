...
namespace LibraryManagementSystem.Forms
{
	partial class ManageCirculationForm
	{
		...
		private void InitializeComponent()
		{
			...
			panelMain.Location = new Point(269, 78);
			panelMain.Name = "panelMain";
			panelMain.Size = new Size(838, 530);
			...
			buttonUpdate.Location = new Point(230, 417);
			...
			labelRenewals.Location = new Point(230, 365);
			...
			textRenewals.Location = new Point(230, 383);
			...
			labelCheckoutDate.Location = new Point(230, 274);
			...
			textDueDate.Location = new Point(230, 337);
			...
			textCheckOutDate.Location = new Point(230, 291);
			...
			labelDueDate.Location = new Point(230, 319);
			...
			panelHeader.Size = new Size(1103, 70);
			...
			buttonClose.Location = new Point(1062, 2);
			...
			panelSidebar.Location = new Point(4, 79);
			panelSidebar.Name = "panelSidebar";
			panelSidebar.Size = new Size(259, 520);
			...
			labelUserCheckOutCount.Location = new Point(12, 210);
			...
			labelPhone.Location = new Point(12, 169);
			...
			labelEmail.Location = new Point(12, 141);
			...
			labelCardNumber.Location = new Point(12, 116);
			...
			labelName.Location = new Point(12, 91);
			...
			labelCheckOutCount.Size = new Size(232, 21);
			labelCheckOutCount.TabIndex = 25;
			labelCheckOutCount.Text = "999999 books checked out";
